// code by minari + DukeLee
//
// demo just a demo
// check check
// October 2019

// The suggestion is naive approach. Do not judge. Please join hands and help each others upgrade the algorithm if possible!!!!
// Thanks - DukeLee, October 2019

//gcc -o demo.out demo.c -Lbt-5.0.0/lib -lbt -Ibt-5.0.0/inc suggestion1.o
...
void Search(BTA *dict, char *search){
    // char search[50];
    // printf("=============SEARCH=================\n");
